...
Rscript script/run_megalodon.R megalodon_results/modified_bases.5mC.bed  megalodon_results/$1_megalodon-freq-perCG.tsv megalodon_results/$1_megalodon-freq-perCG-combStrand.tsv
TIME=$(date +"%Y-%m-%d %T")
printf "\n[$TIME] $1_megalodon-freq-perCG.tsv is created.\n\n"
printf "\n[$TIME] $1_megalodon-freq-perCG-combStrand.tsv is created.\n\n"
